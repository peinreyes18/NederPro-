...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Every grammar lesson on NederPro opens with a free preview — the first rule and its examples. The full lessons, interactive exercises, exam practice, vocabulary quizzes and progress tracking require a subscription, which starts with a 7-day free trial. Cancel before day 7 and you won\'t be charged.',
      },
    },
    {
      '@type': 'Question',
