  ...
  exercises: [
    {
      ...
      content: {
        ...
        items: [
          ...
          { dutchText: 'hond', englishTranslation: 'dog', hint: 'short "o" — "hont"' },
          ...
          { dutchText: 'vrouw', englishTranslation: 'woman', hint: '"ou" = "ow" in how — "frow"' },
          ...
          { dutchText: 'zee', englishTranslation: 'sea', hint: 'long "ee" — like "zay"' },
          ...
          { dutchText: 'vier', englishTranslation: 'four', hint: '"ie" + "r" — "feer"' },
          { dutchText: 'vijf', englishTranslation: 'five', hint: '"ij" = "ay" + soft "f" — "fayf"' },
          { dutchText: 'zes', englishTranslation: 'six', hint: 'short "e" — "zes"' },
          { dutchText: 'zeven', englishTranslation: 'seven', hint: 'long "ee" — "zay-ven"' },
          { dutchText: 'acht', englishTranslation: 'eight', hint: 'short "a" + guttural "ch" — "akht"' },
          { dutchText: 'negen', englishTranslation: 'nine', hint: 'long "ee" — "nay-khen"' },
          { dutchText: 'tien', englishTranslation: 'ten', hint: '"ie" = "ee" — "teen"' },
          // Common nouns
          { dutchText: 'brood', englishTranslation: 'bread', hint: 'long "oo" — "broht"' },
          { dutchText: 'melk', englishTranslation: 'milk', hint: 'short "e" — close to English "milk"' },
          { dutchText: 'water', englishTranslation: 'water', hint: 'Dutch "w" is softer than English' },
          { dutchText: 'appel', englishTranslation: 'apple', hint: 'short "a" — close to English "apple"' },
          { dutchText: 'bloem', englishTranslation: 'flower', hint: '"oe" = "oo" in moon — "bloom"' },
          { dutchText: 'boom', englishTranslation: 'tree', hint: 'long "oo" — "bohm"' },
          { dutchText: 'stad', englishTranslation: 'city', hint: 'short "a" — "stat"' },
          { dutchText: 'werk', englishTranslation: 'work', hint: 'short "e" — "verk"' },
          { dutchText: 'nacht', englishTranslation: 'night', hint: '"ch" is a guttural sound' },
          { dutchText: 'thuis', englishTranslation: 'home', hint: '"ui" sound + "s" — "toyce"' },
        ],
      },
    },
    {
